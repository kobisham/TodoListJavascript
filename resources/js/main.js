...
// Get from local storage or initialize
...
function renderTodoList() {
    ...
    for (var i = 0; i < data.todo.length; i++) {
        var element = data.todo[i];
        addItemTodo(element);
    }

    for (var j = 0; j < data.completed.length; j++) {
        var element = data.completed[j];
        addItemTodo(element,true);
    }
}
...
function addItemTodo(text,completed) {
    ...
    // Remove and complete buttons for each item
    ...
    // Add click events to Remove&Complete buttons
